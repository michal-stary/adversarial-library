...
def fmn2(model: nn.Module,
    ...
    def boundary_search(model: nn.Module,
        ...
        for step in range(steps):
            ...
            δ = distance_to_boundary * direction
            ...
            largest_nadv[not is_adv] = δ[not is_adv]

            # line search
            distance_to_boundary[not is_adv] *= 2

            #binary search
            distance_to_boundary[is_adv] = mid_point(x0=smallest_adv, x1=largest_nadv, ε=ε).norm(p=norm, dim=1)
